...
import 'package:pr8_corpsis/models/cart_item.dart'; // Импортируйте модель CartItem
import 'package:pr8_corpsis/components/item_note.dart'; // Импортируйте ваш компонент для отображения заметки
import 'package:pr8_corpsis/components/cart_card.dart'; // Импортируйте компонент для карточки корзины
